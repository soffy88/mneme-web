  ...
  sections: [
    {
      ...
      cards: [
        ...
        { icon: '✏', title: '专题练习', desc: '按考点分层练习', href: '/subjects/physics/practice', disabled: true },
    ...
    },
    {
      ...
      cards: [
        ...
        { icon: '↺', title: '变式复习', desc: '到期知识点变式巩固', href: '/practice?subject=physics', disabled: true },
        { icon: '◧', title: '真题模考', desc: '高考真题专项训练', href: '/subjects/physics/exam', disabled: true },
      ],
    },
    {
      phase: '独立功能',
      ...
      bg: '#ede9fe',
      cards: [
        { icon: '🔬', title: '虚拟实验室', desc: '物理实验交互模拟', href: '/subjects/physics/lab', disabled: true },
      ],
    },
  ],
};
